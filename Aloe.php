...
<div id="content-wrap">
    ...
    <section id="main">
        ...
        <article class="post">
            ...
            <h2><a href="index.html">ALOE (ALOE VERA)</a></h2>

			<p class="post-info">Posted by <a href="index.html">walaa</a></p>

			<div class="image-section">
                <img src="images/33.jpg" alt="image post" width="550" height="210"/>
         	</div>
			

		
<p>I have many fond memories of aloe plants. When I was a child, if I scraped my knee or developed a sunburn, I knew my cure was only an aloe leaf away.</p>
<p>Besides being medicinal marvels, aloe is also a very easy plant to take care of. If you’ve got a sunny and warm area, aloe will thrive and produce its iconic sharp-thorned green arms.</p>
<h4>Light</h4>
<p>Direct sunlight, and lots of it!</p>
<h4>Water</h4>
<p>Sparingly but thoroughly. Aloe needs to drain completely between watering, otherwise root rot can set in.</p>
<p>Allow the soil to dry completely between waterings, and don’t be afraid to wait a few days even after that.</p>
<h4>Fertilizer</h4>
<p>Use a general-purpose fertilizer diluted to about 50% of its recommended strength, once a month from March to August.</p>

			

			 <!-- edit ///////////////////////// -->
			<p class="button">
			    <a href="Snake Plant (Sansevieria trifasciata).php" class="previous" color="black" >&laquo; Previous</a>
			
			
                <a href="CARING FOR AIR PLANTS.php" class="next">Next &raquo;</a>
			</p>
        </article>
