...
<div id="content-wrap">
    ...
    <section id="main">
        ...
        <article class="post">
            ...
            <h2><a href="index.php">Simple Trick to Grow Orange Trees From Seeds REALLY FAST</a></h2>

<p class="post-info">Posted by <a href="index.php">walaa</a></p>
			<div class="image-section">
                <img src="images/11.jpg" alt="image post" width="550" height="210"/>
         	</div>
			

			<p>I am sure you are aware that if you plant orange seeds in the ground, 
			you will see an orange tree begin to grow within a couple of months.</p>

			<p> But what if you want your orange tree to begin growing faster than that?
			This video shows you how to start growing your orange tree within two or three weeks.
			The video also shows you how to care for your orange tree throughout its life stages.
			Finally, the video presents several unique and interesting facts about citrus fruits.
			For instance, if you plant an orange seed, you will not necessarily grow the same type of orange the seed originated from.</p>

			<p>Please watch this informative video to learn how to grow your own orange tree from a seed.
			</p>
			
			<iframe src="https://www.youtube.com/embed/e8QQOmkIa8Q" width="550" height="305" frameborder="0" allowfullscreen="allowfullscreen"></iframe></p>

			 <!-- edit ///////////////////////// -->
			<p class="button">
			    <a href="Rubber Plant.php" class="previous" color="black" >&laquo; Previous</a>
			
                <a href="Snake Plant (Sansevieria trifasciata).php" class="next">Next &raquo;</a>
			</p>
        </article>
    <!-- /main -->
    </section>
