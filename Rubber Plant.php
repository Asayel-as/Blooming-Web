...
<div id="content-wrap">
    ...
    <section id="main">
        ...
        <article class="post">
            ...
            <h2><a href="index.php">Rubber Plant (Ficus elastica)</a></h2>

<p class="post-info">Posted by <a href="index.php">walaa</a></p>
			<div class="image-section">
                <img src="images/44.jpg" alt="image post" width="550" height="210"/>
         	</div>
			

			
<p>The rubber plant offers a bold burgundy color to its foliage that stands apart from the other plants in this guide. It is a plant that is very tolerant of abuse, great for the more hands-off of indoor gardeners among us.</p>
<p>New growth on these guys can be a sharp red color as the new leaf begins the growing process. If you’re looking for a bold and unique-looking houseplant, the rubber plant is the one for you.</p>
<h4>Light</h4>
<p>Lots of light, but indirect. Put the rubber plant near a sheer curtained window for optimum light exposure.</p>
<p>The dark burgundy leaves are a result of lots of light exposure. With too little light, the plant will develop green foliage instead.</p>
<h4>Water</h4>
<p>Keep the soil moist during the spring and summer, but begin to taper off during the winter months. The leaves of the rubber plant enjoy a good misting.</p>
<h4>Fertilizer</h4>
<p>Once a month during the spring and summer with a water soluble fertilizer is ideal.</p>

			

			 <!-- edit ///////////////////////// -->
			<p class="button">
			    <a href="Peace Lily (Spathyphillum).php" class="previous" color="black" >&laquo; Previous</a>
			
                <a href="Simple Trick to Grow Orange Trees From Seeds REALLY FAST.php" class="next">Next &raquo;</a>
			</p>
        </article>
    <!-- /main -->
    </section>
